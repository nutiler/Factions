...
public class EnginePermBuild extends Engine
{
	...
	public void buildEntity(EntityDamageByEntityEvent event)
	{
		...
		build(player, edamagee.getLocation().getBlock(), event);
	}
	...
	public void buildPiston(BlockPistonExtendEvent event)
	{
		...
		/* NOTE:
		 * I originally was testing the territory of each affected block, but since I found that pistons can only push
